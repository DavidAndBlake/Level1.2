...
frame.setTitle("Insert your title here");
		// 3. Create a JPanel variable to hold the header using the createHeader method
JPanel headerPanel = createHeader("Trains");
...
frame.add(quizPanel);
	...
	secondButton.addActionListener(this);
		...
		frame.pack();
		headerPanel.setLayout(new GridLayout(buttonCount+1, 3));
...
playJeopardyTheme();
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("It is currently the fastest type of train in the world", "What is the maglev train", 200);
			firstButton.setText(null);
			// Fill in the askQuestion() method. When you play the game, the score should change.
		}
		// Or if the buttonPressed was the secondButton
		if (buttonPressed == secondButton) {
			askQuestion("It connects the driving wheels on a steam locomotive together", "What is the coupling rod", 200);
	...
	String answer = JOptionPane.showInputDialog(question);
		...
		// Otherwise
			...
			JOptionPane.showMessageDialog(null, "Sorry, that was incorrect. The correct answer was " + correctAnswer);
			// Call the updateScore() method
			updateScore();
		}
