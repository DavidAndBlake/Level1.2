	...
	public String getTicketPrice() {
			...
			} else if (this.title.contains("The Room")) {
				return "You're going to watch THAT movie!? No, please don't!\nThat movie will kill your brain cells! What's wrong with you? YOU ARE TEARING ME APART VIEWER!\n";
			} else {
